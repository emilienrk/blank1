...
| [0002](0002-rgpd-soft-delete.md) | RGPD à délai de grâce archivé → soft-delete | à venir (étape 2) |
| [0003](0003-back-office-archive.md) | Back-office archivé — admin via CLI/SQL | à venir (étape 1) |
| [0004](0004-observabilite-docker-logs.md) | Observabilité lourde archivée — `docker logs` | à venir (étape 1) |
